...
最終更新: 2026-06-17 (v0.48.2 設備の定期保守点検 — condition 3 段モデル / 代官による自動保守を §6.6b へ同期。あわせて v0.48.1 設備維持管理〔condition 駆動の減衰→機能不全→修理→破壊 + 設備による Crisis 被害軽減〕も §6.6 / §6.6b / §9 に反映済み)
