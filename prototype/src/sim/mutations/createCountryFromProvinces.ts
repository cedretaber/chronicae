...
export function createCountryFromProvinces(
  ...
  const country: Country = {
    ...
    legitimacy: finalCtx.config.revoltCountryInitialLegitimacy,
    adminPower: finalCtx.config.revoltCountryInitialAdminPower,
    stability: finalCtx.config.revoltCountryInitialStability,
    roleAssignments: {},
    active: true,
    capitalProvinceId: params.capitalProvinceId,
  }
