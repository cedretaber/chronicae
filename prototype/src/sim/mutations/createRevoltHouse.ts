...
export function createRevoltHouse(
  ...
  const house: House = {
    ...
    cadetHouseIds: [],
    prestige: finalCtx.config.revoltHouseInitialPrestige,
    cohesion: finalCtx.config.revoltHouseInitialCohesion,
    loyaltyToCountry: finalCtx.config.revoltHouseInitialLoyaltyToCountry,
