...
export type EventType =
  ...
  | 'MERCHANT_COMPANY_BANKRUPT'
  | 'MERCHANT_COMPANY_FOUNDED'
  | 'MERCHANT_ROUTE_OPENED'
  | 'MERCHANT_ROUTE_UPGRADED'
  | 'MERCHANT_ROUTE_CLOSED'
  | 'MERCHANT_BRANCH_BUILT'
  | 'MERCHANT_HQ_UPGRADED'
  // v0.51 兵站・補給・消耗
  | 'SUPPLY_PLUNDER'
