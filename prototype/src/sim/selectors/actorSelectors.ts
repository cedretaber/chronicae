...
export function getActorResourceAmount(state: WorldState, actor: OrganizationRef): number {
  if (actor.kind === 'polity') {
...
export function politicalActorKey(ref: OrganizationRef): string {
...
export function isActorActive(state: WorldState, actor: OrganizationRef): boolean {
  if (actor.kind === 'polity') {
...
export function isSameActor(a: OrganizationRef, b: OrganizationRef): boolean {
...
export function polityActor(id: PolityId): OrganizationRef {
  return { kind: 'polity', id }
}

export function houseActor(id: HouseId): OrganizationRef {
